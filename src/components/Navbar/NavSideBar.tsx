                ...
                <div className='my-15'>
                    ...
                    } */}
                    {
                        env === 'development' ?
                            <>
                                <hr />
                                <Text subtitle className='mt-3 !text-[18px]'>Blogs</Text>
                                <LinkTo href='/pages/blog/react-and-next.tsx' passHref className='text-[16px] block my-3'>
                                    React and Next.js
                                </LinkTo>
                                <LinkTo href='/pages/blog/js-garbage-collector.tsx' passHref className='text-[16px] block my-3'>
